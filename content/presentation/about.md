...
Start from the [workshop presentation index](index.html). It provides access to all three workshop days.

| Day | Presentation | Main Topics |
| --- | --- | --- |
| 1 | [Basic Concepts](airflow_day1/index.html) | Airflow architecture, DAGs, tasks, operators, scheduling, Assets, deployment options, and the UI |
| 2 | [DAGs, dbt, and Integrations](airflow_day2/index.html) | Trigger rules, data intervals, catchup, Dynamic Task Mapping, XCom, dbt, Connections, and task return values |
| 3 | [Production, Diagnostics, and Monitoring](airflow_day3/index.html) | DAG testing, CI/CD, DAG Bundles, troubleshooting, Pools, idempotency, observability, security, and scaling |
...
All presentations share the same visual style, navigation controller, and brand assets from `shared/`.
